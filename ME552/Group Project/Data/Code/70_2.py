...
fuelmass = 42.5 * ureg.gram # Measured value
potmeasurement = 99.1 * ureg.gram # Measured value
watermassmeasurement = 590.3 * ureg.gram # Measured value
...
starttemp = 295.95 * ureg.kelvin # Measured value
tempreading = Q_(75.9, ureg.degF) # Measured value
ambienttemp = tempreading.to(ureg.kelvin) # Convert to kelvin
finaltemp = 361.15 * ureg.kelvin # Measured value

# Add in the pressure measurements of the sampling tube
# Will be input and output in inches of water
pressurediff = 0.456430 * ureg.inch_H2O_39F # Measured value
...
COlevel = 10.2448 * 1.e-6 * ureg.mol/ureg.mol # Measured value
CO2level = 189.6773 * 1.e-6 * ureg.mol/ureg.mol # Measured value

# Add in burn time, in seconds
minutes = 31. * ureg.minute # Measured value
seconds = 04. * ureg.second # Measured value
