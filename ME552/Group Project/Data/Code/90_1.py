...
hotwatermass = 439 * ureg.gram # Measured value

# Poured volume of fuel in liters
fuelvolume = 50 * ureg.milliliter # Measured value

# Temperature measurements
starttemp = 294.35 * ureg.kelvin # Measured value
...
pressurediff = 0.458340 * ureg.inch_H2O_39F # Measured value
...
COlevel = 17.1498 * 1.e-6 * ureg.mol/ureg.mol # Measured value
CO2level = 347.1193 * 1.e-6 * ureg.mol/ureg.mol # Measured value
