...
fuelmass = 0.042 # Measured value
potmeasurement = 0.0991 # Measured value
watermassmeasurement = 0.5903 # Measured value
ethanolmass = 0.286 # Measured value
bottletotal = 0.408 # Measured value
hotwatermass = 0.462 # Measured value

# Poured volume of fuel in liters
fuelvolume = 0.050 # Measured value

# Temperature measurements
starttemp = 295.95 # Measured value
ambienttemp = 297.54 # Measured value
finaltemp = 361.15 # Measured value
...
COlevel = 10.24 # Measured value, points 1 to 689
CO2level = 189.67 # Measured value, points 1 to 689

# Add in burn time, in seconds
minutes = 31. # Measured value
seconds = 04. # Measured value
