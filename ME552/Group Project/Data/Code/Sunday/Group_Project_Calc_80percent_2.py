...
fuelmass = 0.0412 # Measured value
potmeasurement = 0.0993 # Measured value
watermassmeasurement = 0.590 # Measured value
ethanolmass = 0.318 # Measured value
bottletotal = 0.396 # Measured value
hotwatermass = 0.440 # Measured value

# Poured volume of fuel in liters
fuelvolume = 0.050 # Measured value

# Temperature measurements
starttemp = 296.35 # Measured value
ambienttemp = 297.42 # Measured value
finaltemp = 365.65 # Measured value
...
COlevel = 12.50 # Measured value, points 40 to 621
CO2level = 298.35 # # Measured value, points 40 to 621

# Add in burn time, in seconds
minutes = 28. # Measured value
seconds = 42. # Measured value
