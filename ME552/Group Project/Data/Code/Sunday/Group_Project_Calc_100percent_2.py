...
fuelmass = 0.038 # Measured value, not used
...
hotwatermass = 0.436 # Measured value

# Poured volume of fuel in liters
fuelvolume = 0.050 # Measured value

# Temperature measurements
starttemp = 301.15 # Measured value
ambienttemp = 297.2 # Measured value
...
# Exhaust gas constituent measurements above background
COlevel = 15.573 # Measured value, points 141 to 531
CO2level = 316.237 # Measured value, points 141 to 531

# Burn time
minutes = 20. # Measured value
seconds = 12. # Measured value
