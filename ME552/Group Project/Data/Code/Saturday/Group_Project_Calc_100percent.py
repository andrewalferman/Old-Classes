...
fuelmass = 0.046 # Measured value, not used
potmeasurement = 0.099 # Measured value
watermassmeasurement = 0.246 # Measured value
ethanolmass = 1. # Dummy value because 100% ethanol was used
bottletotal = 1. # Dummy value because 100% ethanol was used
hotwatermass = 0.122 # Test was intrurrupted, can't determine accurately

# Poured volume of fuel in liters
fuelvolume = 0.060 # Measured value

# Temperature measurements
starttemp = 294.55 # Measured value
ambienttemp = 297.48 # Measured value
finaltemp = 373.15 # Water was boiling, more accurate than therocouple
...
barpressure = 1018.5 # Measured value

# Exhaust gas constituent measurements
COlevel = 10. # Incomplete data, can't determine accurately
CO2level = 200. # Incomplete data, can't determine accurately

# Burn time
minutes = 24. # Measured value
seconds = 50. # Measured value
